...
public class agregarArch extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String sql = "insert into ESPECIALIDAD (NOM_ESPECIALIDAD) values (?)";
        try{
            instruc = conn.prepareStatement(sql);
            instruc.setString(1, agregar.getText());
            instruc.executeUpdate();
            Component panel = null;
            JOptionPane.showMessageDialog(panel, "La especialidad "+agregar.getText()+" ha sido agregada", "Éxito", JOptionPane.INFORMATION_MESSAGE);
            agregar.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(agregarArch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new agregarArch().setVisible(true);
            }
        });
    }
